...
const zh: Record<string, string> = {
  ...
  langToggle: 'EN',
  entitiesDir: '实体存储位置',
  entitiesDirBusy: '修改实体存储位置',
  entitiesDirChanged: '实体存储位置已更改',
  deleteVersion: '删除版本',
  pickDirTitle: '选择文件夹',
...
const en: Record<string, string> = {
  ...
  langToggle: '中',
  entitiesDir: 'Entity storage',
  entitiesDirBusy: 'changing entity storage',
  entitiesDirChanged: 'Entity storage location updated',
