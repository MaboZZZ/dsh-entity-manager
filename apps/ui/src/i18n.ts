...
const zh: Record<string, string> = {
  ...
  deleteVersion: '删除版本',
  pickDirTitle: '选择文件夹',
  pickFileTitle: '选择实体包文件',
  chooseBundleFile: '选择文件',
  addLocalTitle: '添加本地版本',
  dataDirTitle: '版本数据目录',
  cancel: '取消',
  register: '注册',
...
const en: Record<string, string> = {
  ...
  pickDirTitle: 'Choose folder',
  pickFileTitle: 'Choose entity bundle file',
  chooseBundleFile: 'Choose file',
  addLocalTitle: 'Add local version',
  dataDirTitle: 'Version data directory',
  cancel: 'Cancel',
  register: 'Register',
